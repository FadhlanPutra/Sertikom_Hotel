...
if(isset($_POST['search'])) {
    ...
    $sql = "SELECT * FROM tbl_penyewa WHERE nama='$nama'";
    $hasil = $db->query($sql);
...
if(isset($_POST['search1'])) {
    ...
    $sql = "SELECT * FROM tbl_penyewa WHERE jenis_kamar='$jenis_kamar'";
    $hasil = $db->query($sql);
    $data = mysqli_fetch_array($hasil);
...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="POST" action="Search_penyewa.php">
            ...
            <a href="../table/Table_penyewa.php"><button class="btn btn-warning">Munculkan Semua Data</button></a>
            <!-- Navbar-->
