...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" method="POST" action="../proses/Search_kamar.php">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <a href="../tambah/Tambah_Kamar.php"><button type="submit" class="btn btn-primary" style="width:160px; margin-left:10px; font-size:15px;">Tambah Data Kamar</button></a>
                        </ol>
                        <div class="card mb-4">
